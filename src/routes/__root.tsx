...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "win1 — Gaming & Reward Vault" },
      { name: "description", content: "Cyberpunk gaming and reward vault with reels, card match and UPI top-ups." },
      { name: "author", content: "win1" },
      { property: "og:title", content: "win1 — Gaming & Reward Vault" },
    ...
    scripts: [
      {
        src: "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7422138384098542",
